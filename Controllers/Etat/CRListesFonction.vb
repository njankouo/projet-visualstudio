...
Public Class CRListesFonction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplicationGespaie.CRListesFonction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRListesFonction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRListesFonction = New CRListesFonction()
        rpt.Site = Me.Site
        Return rpt
    End Function
