...
Public Class CRListesPersonnel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplicationGespaie.CRListesPersonnel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRListesPersonnel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRListesPersonnel = New CRListesPersonnel()
        rpt.Site = Me.Site
        Return rpt
    End Function
