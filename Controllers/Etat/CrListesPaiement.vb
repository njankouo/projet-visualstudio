...
Public Class CrListesPaiement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplicationGespaie.CrListesPaiement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrListesPaiement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrListesPaiement = New CrListesPaiement()
        rpt.Site = Me.Site
        Return rpt
    End Function
