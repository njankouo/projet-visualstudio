...
Public Class Crutilisateur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplicationGespaie.Crutilisateur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrutilisateur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crutilisateur = New Crutilisateur()
        rpt.Site = Me.Site
        Return rpt
    End Function
