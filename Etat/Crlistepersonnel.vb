...
Public Class Crlistepersonnel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplicationGespaie.Crlistepersonnel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrlistepersonnel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crlistepersonnel = New Crlistepersonnel()
        rpt.Site = Me.Site
        Return rpt
    End Function
