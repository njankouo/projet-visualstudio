...
Public Class CRLISTEUTILISATEUR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplicationGespaie.CRLISTEUTILISATEUR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLISTEUTILISATEUR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLISTEUTILISATEUR = New CRLISTEUTILISATEUR()
        rpt.Site = Me.Site
        Return rpt
    End Function
